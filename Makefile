...
build-7.0:
	echo "Building: 7.0"
	docker build  --tag michaelcontento/php:7.0 7.0

	echo "Building: 7.0-debug"
	docker build  --tag michaelcontento/php:7.0-debug 7.0-debug

	echo "Building: 7.0-laravel"
	docker build  --tag michaelcontento/php:7.0-laravel 7.0-laravel

	echo "Building: 7.0-laravel-debug"
	docker build  --tag michaelcontento/php:7.0-laravel-debug 7.0-laravel-debug

build-7.1:
	echo "Building: 7.1"
	docker build  --tag michaelcontento/php:7.1 7.1

	echo "Building: 7.1-debug"
	docker build  --tag michaelcontento/php:7.1-debug 7.1-debug

	echo "Building: 7.1-laravel"
	docker build  --tag michaelcontento/php:7.1-laravel 7.1-laravel

	echo "Building: 7.1-laravel-debug"
	docker build  --tag michaelcontento/php:7.1-laravel-debug 7.1-laravel-debug

build-7.2:
	echo "Building: 7.2"
	docker build  --tag michaelcontento/php:7.2 7.2
	...
	docker build  --tag michaelcontento/php:7.2-debug 7.2-debug
	...
	docker build  --tag michaelcontento/php:7.2-laravel 7.2-laravel
	...
	docker build  --tag michaelcontento/php:7.2-laravel-debug 7.2-laravel-debug
