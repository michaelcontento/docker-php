...
push-7.0:
	...
	docker push michaelcontento/php:7.0-debug 7.0-debug
	docker push michaelcontento/php:7.0-laravel 7.0-laravel
	docker push michaelcontento/php:7.0-laravel-debug 7.0-laravel-debug
